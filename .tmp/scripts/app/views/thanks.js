...
(function() {
  ...
  define(["jquery", "underscore", "backbone", "handlebars", "text!app/templates/thanks.hbs"], function($, _, Backbone, Handlebars, thanksTemplate) {
    'use strict';
    ...
    return ContactView = (function(_super) {
      ...
      ContactView.prototype.template = Handlebars.compile(thanksTemplate);
